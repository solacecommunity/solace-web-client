...
```sh
git clone https://github.com/solacecommunity/solace-web-client
```
...
```sh
$ git remote add upstream https://github.com/solacecommunity/solace-web-client
```
...
In GitHub, send a pull request to `solace-web-client:master`.
